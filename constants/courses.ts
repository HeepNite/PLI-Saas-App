...
export const demoCourses: CourseData[] = [
  {
    ...
    enrollment: {
      ...
      packages: [
        { id: "night-flex", label: "Night Flex (8 classes)", price: 140, description: "8 night classes / month", meta: { cadence: "2-3 classes/week", totalClasses: 8 } },
        { id: "night-pro", label: "Night Pro (unlimited)", price: 220, description: "Unlimited classes / month", meta: { cadence: "Unlimited", totalClasses: 0 } },
      ],
      addons: [
  ...
  },
  {
    ...
    enrollment: {
      ...
      packages: [
        { id: "morning-3-week", label: "Morning 3-week pack", price: 145, description: "8 classes + 8 make-ups", meta: { cadence: "3 classes/week", totalClasses: 8, makeUps: 8 } },
        { id: "morning-2-week", label: "Morning 2-week pack", price: 125, description: "5 classes + 5 make-ups", meta: { cadence: "2-3 classes/week", totalClasses: 5, makeUps: 5 } },
        { id: "morning-1-week", label: "Morning 1-week pack", price: 90, description: "3 classes + 3 make-ups", meta: { cadence: "3 classes/week", totalClasses: 3, makeUps: 3 } },
        { id: "morning-monthly", label: "Morning Monthly", price: 200, description: "1 class per day, make-ups included", meta: { cadence: "1 class per day", totalClasses: 0, makeUps: 0 } },
        { id: "morning-6-month", label: "Morning 6-month pack", price: 480, description: "1 class per day, no make-ups", meta: { cadence: "1 class per day", totalClasses: 0, makeUps: 0 } },
      ],
      addons: [],
    },
  },
  ...
  },
  {
    ...
    enrollment: {
      ...
      packages: [
        { id: "babies-3-week", label: "Babies 3-week pack", price: 145, description: "8 classes + 8 make-ups", meta: { cadence: "2 classes/week", totalClasses: 8, makeUps: 8 } },
        { id: "babies-2-week", label: "Babies 2-week pack", price: 125, description: "5 classes + 5 make-ups", meta: { cadence: "2 classes/week", totalClasses: 5, makeUps: 5 } },
        { id: "babies-1-week", label: "Babies 1-week pack", price: 90, description: "3 classes + 3 make-ups", meta: { cadence: "2 classes/week", totalClasses: 3, makeUps: 3 } },
        { id: "babies-monthly", label: "Babies Monthly", price: 200, description: "1 class per day, make-ups included", meta: { cadence: "2 classes/week", totalClasses: 0, makeUps: 0 } },
      ],
      addons: [
