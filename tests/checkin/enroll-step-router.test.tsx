...
vi.mock("@/components/front/checkin/ProfilePhotoCapture", () => ({
  default: ({ onSaved, onSkipped }: { onSaved: () => void; onSkipped: () => void }) =>
    React.createElement("div", { "data-testid": "profile-photo-capture" }, "ProfilePhotoCapture"),
}))
...
const baseCourse: CourseEnrollmentData = {
  ...
  schedule: { availableWeekdays: [1, 3], availableTimes: ["20:00", "21:00"] },
}
