...
export function SchoolWizardStepNav({ steps, currentStep, onStepClick, enabledContext, stretch }: SchoolWizardStepNavProps) {
        ...
        return (
          <React.Fragment key={st.key}>
            <button
              ...
              className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[11px] font-medium transition whitespace-nowrap ${stretch ? "flex-1 justify-center" : ""} ${
                active
