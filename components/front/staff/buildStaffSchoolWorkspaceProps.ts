  ...
  return {
    ...
    courseStudio: {
      ...
      preview: {
        ...
        concreteSlotCount: courseScheduleSlots.filter((slot) => slot.date).length,
        formatUsdInputLabel,
        formatClockLabel,
        getCourseScheduleDateTooltip,
        getCourseScheduleDateTone,
      },
      publish: { courseEditingSlug, previewPublicHref, schoolBusy, courseMediaUploading, onCopyCourseLink: () => void copyCourseLink(), onShareCourse: shareCourse, onResetCourseBuilder: resetCourseBuilder, onSaveDraft: () => void saveCourseCatalog(undefined, "save_draft"), onPublish: () => void saveCourseCatalog(undefined, "publish") },
    },
    courseCatalog: {
