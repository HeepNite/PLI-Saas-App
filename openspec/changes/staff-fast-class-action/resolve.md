...
| Promo offer | After the first class action succeeds, the server may return a promo offer when a linked later class exists today. The UI shows a popup asking `Staying for the next class?`. |
