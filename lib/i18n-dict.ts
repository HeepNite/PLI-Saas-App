...
const translationsObj = {
  ...
  es: {
    ...
    payments_onSite: "Cash",
    payments_onSite_desc: "Paga en efectivo en recepción.",
    payments_stripe: "Card",
    payments_stripe_desc: "Paga con tarjeta.",
    ...
    existing_customer_signin_required:
      "Este número ya está registrado con un usuario. Por favor inicie sesión para continuar con el proceso.",
    identity_check_failed: "No pudimos validar tu cuenta ahora. Intenta nuevamente.",
